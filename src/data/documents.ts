...
export const documents: DocumentCard[] = [
  ...
  },
  {
    ...
    number: "06",
    title: {
      en: "PR3538746 MVP Sheet",
      ar: "ورقة MVP الخاصة بـ PR3538746",
      fr: "Fiche MVP PR3538746",
    },
    category: "Product Documents",
    status: "technical-review",
    access: "nda",
    description: {
      en: "PR3538746 Smart Fault Exploration as the R&D-ready smart exploration MVP.",
      ar: "PR3538746 Smart Fault Exploration بوصفه نموذج MVP للاستكشاف الذكي الجاهز للبحث والتطوير.",
      fr: "PR3538746 Smart Fault Exploration en tant que MVP d'exploration intelligente prêt pour la R&D.",
    },
